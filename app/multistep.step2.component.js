...
var MultistepStep2Component = (function (_super) {
    __extends(MultistepStep2Component, _super);
    function MultistepStep2Component(multistepService) {
        var _this = _super.call(this, multistepService) || this;
        _this.multistepService = multistepService;
        return _this;
    }
    MultistepStep2Component.prototype.ngOnInit = function () {
        this.model = this.multistepService.model;
    };
    return MultistepStep2Component;
}(multistep_form_class_1.MultistepFormClass));
__decorate([
    core_1.ViewChild('form'),
    __metadata("design:type", forms_1.NgForm)
], MultistepStep2Component.prototype, "latestForm", void 0);
MultistepStep2Component = __decorate([
    core_1.Component({
...
exports.MultistepStep2Component = MultistepStep2Component;
//# sourceMappingURL=multistep.step2.component.js.map